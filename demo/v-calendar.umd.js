...
var _index = _interopRequireDefault(__webpack_require__("2cfd"));

var _index2 = _interopRequireDefault(__webpack_require__("cd8f"));

var _index3 = _interopRequireDefault(__webpack_require__("6068"));
...
// EXTERNAL MODULE: ./src/utils/dateInfo.js + 3 modules
...
// EXTERNAL MODULE: ./node_modules/date-fns/addDays/index.js
var addDays = __webpack_require__("a99c");
var addDays_default = /*#__PURE__*/__webpack_require__.n(addDays);

// EXTERNAL MODULE: ./node_modules/date-fns/addMonths/index.js
var addMonths = __webpack_require__("cd8f");
var addMonths_default = /*#__PURE__*/__webpack_require__.n(addMonths);

// EXTERNAL MODULE: ./node_modules/date-fns/addYears/index.js
var addYears = __webpack_require__("0156");
var addYears_default = /*#__PURE__*/__webpack_require__.n(addYears);
        ...
        case 'ArrowLeft':
          {
            ...
            newDate = addDays_default()(date, -1);
            break;
          }
        ...
        case 'ArrowUp':
          {
            ...
            newDate = addDays_default()(date, -7);
            break;
          }
        ...
        case 'Home':
          {
            ...
            newDate = addDays_default()(date, -day.weekdayPosition + 1);
            break;
          }
        ...
        case 'End':
          {
            ...
            newDate = addDays_default()(date, day.weekdayPositionFromEnd);
            break;
          }
        ...
        case 'PageUp':
          {
            if (event.altKey) {
              ...
              newDate = addYears_default()(date, -1);
            } else {
              // Move to previous month
              newDate = addMonths_default()(date, -1);
            }
...
const evalFn = function (fn, args) {
  return Object(___WEBPACK_IMPORTED_MODULE_0__[/* isFunction */ "j"])(fn) ? fn(args) : fn;
};
...
var _index2 = _interopRequireDefault(__webpack_require__("d8e8"));
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "a", function() { return /* binding */ dateInfo_DateInfo; });
...
class dateInfo_DateInfo {
  constructor(config, {
    ...
    this.order = order;
    this.locale = locale instanceof utils_locale["b" /* default */] ? locale : new utils_locale["b" /* default */](locale);
    this.firstDayOfWeek = this.locale.firstDayOfWeek; // Adjust config for simple dates

    if (!Object(_["l" /* isObject */])(config)) {
    ...
    const andOpt = Object(helpers["i" /* mixinOptionalProps */])(config, {}, dateInfo_DateInfo.patternProps);
    ...
    if (config.on) {
      const or = (Object(_["h" /* isArray */])(config.on) ? config.on : [config.on]).map(function (o) {
        if (Object(_["j" /* isFunction */])(o)) return o;
        const opt = Object(helpers["i" /* mixinOptionalProps */])(o, {}, dateInfo_DateInfo.patternProps);
    ...
    return {
      ...
      days: {
        validate: function (days) {
          return Object(_["h" /* isArray */])(days) ? days : [parseInt(days, 10)];
        },
      ...
      weekdays: {
        validate: function (weekdays) {
          return Object(_["h" /* isArray */])(weekdays) ? weekdays : [parseInt(weekdays, 10)];
        },
      ...
      ordinalWeekdays: {
        validate: function (ordinalWeekdays) {
          return Object.keys(ordinalWeekdays).reduce(function (obj, ck) {
            ...
            obj[ck] = Object(_["h" /* isArray */])(weekdays) ? weekdays : [parseInt(weekdays, 10)];
            return obj;
          }, {});
        },
      ...
      weeks: {
        validate: function (weeks) {
          return Object(_["h" /* isArray */])(weeks) ? weeks : [parseInt(weeks, 10)];
        },
      ...
      months: {
        validate: function (months) {
          return Object(_["h" /* isArray */])(months) ? months : [parseInt(months, 10)];
        },
      ...
      years: {
        validate: function (years) {
          return Object(_["h" /* isArray */])(years) ? years : [parseInt(years, 10)];
        },
  ...
  static testConfig(config, day, dateInfo) {
    if (Object(_["j" /* isFunction */])(config)) return config(day);
  ...
  iterateDatesInRange({
    ...
    if (!start || !end || !Object(_["j" /* isFunction */])(fn)) return null;
...
var _index = _interopRequireDefault(__webpack_require__("6068"));
...
Object(___WEBPACK_IMPORTED_MODULE_0__[/* toPairs */ "v"])(locales).forEach(function ([id, {
  dow,
  L
}]) {
  locales[id] = {
